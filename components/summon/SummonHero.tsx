export default function SummonHero({ prefix = "" }: { prefix?: string }) {
  return (
    <section className="relative py-14 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent">
          Summon – Wissen, das sofort wirkt
        </h1>
        <p className="mt-4 text-gray-300 text-base sm:text-lg">
          Stell eine Frage zu deinem Sicherheits‑ oder Betriebsproblem, und ClawGuru liefert die passenden Runbooks – inklusive Confidence‑Score und Anleitung.
        </p>
        <div className="mt-6">
