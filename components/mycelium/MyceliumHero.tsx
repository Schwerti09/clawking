export default function MyceliumHero({ prefix = "" }: { prefix?: string }) {
  return (
    <section className="relative py-14 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent">
          Mycelium – Das lebendige Wissensnetzwerk
        </h1>
        <p className="mt-4 text-gray-300 text-base sm:text-lg">
          Erkunde die Zusammenhänge zwischen Runbooks, CVEs, Services und Best Practices. Jeder Knoten ist ein Runbook, jede Verbindung eine gemeinsame Schwachstelle oder Abhängigkeit.
        </p>
        <div className="mt-6">
