export default function OracleHero({ prefix = "" }: { prefix?: string }) {
  return (
    <section className="relative py-14 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent">
          Oracle – Dein prädiktiver Risikoradar
        </h1>
        <p className="mt-4 text-gray-300 text-base sm:text-lg">
          Sieh voraus, welche Schwachstellen als nächstes relevant werden – mit konkreten Runbook‑Empfehlungen und Eintrittswahrscheinlichkeiten.
        </p>
        <div className="mt-6">
