...
export default function FixPageClient({ slug, fixData }: Props) {
  ...
  const prBody = [
    ...
    "",
    "---",
    "_Auto-generated by [ClawGuru WorldBeast](https://clawguru.org) 🦞_",
  ].join("\n")
        ...
        <div>
          ...
          {fixData.testingSteps.length > 0 && (
            <div className="p-4 rounded-xl glass-card">
              <div className="font-black text-sm mb-2">✅ Testing Checklist</div>
      ...
      {prMode && (
        <div>
          ...
          <div className="mt-4 p-4 rounded-xl glass-card text-xs text-gray-500">
            💡 Copy the PR description above, then open a new Pull Request on GitHub and paste it into the description field.
          </div>
        </div>
      )}
    </div>
