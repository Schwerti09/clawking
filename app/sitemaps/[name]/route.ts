  ...
  try {
    if (name === `main-${locale}` || name === "main") {
      ...
      const MOLTBOT_SLUGS = [
        ...
        "api-rate-limiting-advanced","ai-agent-threat-model","real-time-cve-feed","bot-security-testing","sbom-generation","compliance-automation-engine","ai-agent-security",
      ]
