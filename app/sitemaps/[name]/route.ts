...
export async function GET(
  ...
  try {
    if (name === `main-${locale}` || name === "main") {
      ...
      // Moltbot subpages (34 pages × all locales)
      const MOLTBOT_SLUGS = [
        "moltbot-security-fundamentals","moltbot-threat-modeling-guide","moltbot-iam-hardening","moltbot-network-security","moltbot-data-encryption","hardening-guide-2024","security-framework","threat-detection-setup","network-security-firewall",
