  ...
  try {
    if (name === `main-${locale}` || name === "main") {
      ...
      const MOLTBOT_SLUGS = [
        ...
        // Phase 6: New pages (11)
        "ai-agent-security-asia","ai-agent-security-latam","ai-agent-security-tokyo",
        "ai-agent-security-singapore","ai-agent-security-bangalore",
        "ai-agent-security-mexico-city","ai-agent-security-sao-paulo",
        "ai-agent-security-seoul","ai-agent-security-jakarta",
        "ai-agent-security-buenos-aires","ai-agent-security-santiago",
      ...
      const urls = [
        ...
        { loc: `${base}/${locale}/roast-my-moltbot/hall-of-shame`, lastmod, changefreq: "weekly", priority: "0.88" },
        { loc: `${base}/${locale}/roast-my-moltbot/share-badge-gallery`, lastmod, changefreq: "weekly", priority: "0.88" },
        { loc: `${base}/${locale}/roast-my-moltbot/weekly-roast`, lastmod, changefreq: "weekly", priority: "0.88" },
        ...
        { loc: `${base}/${locale}/academy/cve/CVE-2025-45101`, lastmod, changefreq: "monthly", priority: "0.92" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-45102`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-46101`, lastmod, changefreq: "monthly", priority: "0.92" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-46102`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-47101`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-47102`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-48101`, lastmod, changefreq: "monthly", priority: "0.92" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-48102`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-49101`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-49102`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-50101`, lastmod, changefreq: "monthly", priority: "0.92" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-50102`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-51101`, lastmod, changefreq: "monthly", priority: "0.92" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-51102`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-51103`, lastmod, changefreq: "monthly", priority: "0.90" },
        { loc: `${base}/${locale}/academy/cve/CVE-2025-51104`, lastmod, changefreq: "monthly", priority: "0.92" },
