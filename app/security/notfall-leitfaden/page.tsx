  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(239,68,68,0.1),transparent_40%)] animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(248,113,113,0.1),transparent_40%)] animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>

      <Container>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }} />
        <div className="py-16 max-w-4xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-2 rounded-full border border-red-500/30 bg-red-900/30 text-red-400 text-xs font-black animate-fade-in-up">
            🔥 Notfall-Protokoll
          </div>
          <h1 className="mt-4 text-4xl md:text-5xl font-black text-gray-100 bg-gradient-to-r from-gray-100 via-white to-gray-100 bg-clip-text text-transparent animate-fade-in-up" style={{animationDelay: '0.1s'}}>
            Wenn du exponiert bist: jetzt so
          </h1>
          <p className="mt-4 text-gray-300 text-lg leading-relaxed animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            Ziel: Schaden stoppen, Zugang schließen, Schlüssel rotieren, Spuren sichern.
          </p>

        <div className="mt-10 space-y-6 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
          {[
            ...
            <div key={t as string} className="p-6 rounded-2xl border border-gray-700/50 bg-gray-800/80 backdrop-blur-lg shadow-2xl hover:border-red-500/30 transition-all duration-300">
              <div className="font-black text-xl mb-3 text-red-400">{t}</div>
        ...
        <div className="mt-10 p-7 rounded-2xl border animate-fade-in-up" style={{animationDelay: '0.4s', borderColor: "rgba(220,38,38,0.3)", background: "rgba(220,38,38,0.06)" }}>
        ...
        <div className="mt-10 p-7 rounded-2xl border border-gray-700/50 bg-gray-800/80 backdrop-blur-lg shadow-2xl hover:border-cyan-500/30 transition-all duration-300 animate-fade-in-up" style={{animationDelay: '0.5s'}}>
          <div className="font-black text-2xl text-gray-100">Direkt danach</div>
          <p className="mt-2 text-gray-300">
            Nutze Sprint + Tools + Vault, damit du nicht nächste Woche wieder hier landest.
          </p>
          <div className="mt-5 flex flex-wrap gap-3">
            <a className="px-5 py-3 rounded-xl bg-cyan-900/30 border border-cyan-700 hover:bg-cyan-900/40 font-black text-cyan-400" href="/academy">
              Hardening Sprint
            </a>
            <a className="px-5 py-3 rounded-xl bg-gray-900/50 border border-gray-700 hover:bg-gray-900/60 font-black text-gray-300" href="/tools">
              Validator
            </a>
            <a className="px-5 py-3 rounded-xl bg-gray-900/50 border border-gray-700 hover:bg-gray-900/60 font-black text-gray-300" href="/copilot">
              Copilot
            </a>
          </div>
        </div>
