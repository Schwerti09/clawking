    ...
    <Container>
      <div className="py-16 max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link className="p-6 rounded-2xl border border-gray-800 bg-black/30 hover:bg-black/40" href="/security/notfall-leitfaden">
          ...
          <Link className="p-6 rounded-2xl border border-gray-800 bg-black/30 hover:bg-black/40" href="/openclaw-security-2026#cves">
          ...
          <Link className="p-6 rounded-2xl border border-gray-800 bg-black/30 hover:bg-black/40" href="/tools">
            <div className="text-brand-orange font-black">Tools</div>
            <div className="text-gray-400">Validatoren, Checklisten, Reports.</div>
          </Link>
          <Link className="p-6 rounded-2xl border border-gray-800 bg-black/30 hover:bg-black/40" href="/copilot">
          ...
          <Link className="p-6 rounded-2xl border border-[#00ff9d]/20 bg-[#00ff9d]/5 hover:bg-[#00ff9d]/10 md:col-span-2" href="/security/zero-knowledge">
