  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-4">Moltbot vs OpsGenie</h1>
        <p className="text-lg text-gray-600 mb-8">OpsGenie ist ein generisches On-Call-Management-Tool (Atlassian). Moltbot ist Security-First Incident Response mit Auto-Remediation und Executable Playbooks.</p>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4">🏆 Entscheidungshilfe</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-green-50 border border-green-200 p-5 rounded-lg">
              <h3 className="font-bold text-green-800 mb-2">🤖 Moltbot wenn...</h3>
            ...
            <div className="bg-orange-50 border border-orange-200 p-5 rounded-lg">
              <h3 className="font-bold text-orange-800 mb-2">🔔 OpsGenie wenn...</h3>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <a href="/securitycheck" className="block bg-gray-50 p-4 rounded-lg hover:bg-gray-100"><div className="font-semibold text-blue-600">🛡️ Security Check</div><div className="text-sm text-gray-600">Moltbot testen</div></a>
            <a href="/runbooks" className="block bg-gray-50 p-4 rounded-lg hover:bg-gray-100"><div className="font-semibold text-blue-600">📚 IR Runbooks</div><div className="text-sm text-gray-600">Incident Playbooks</div></a>
          </div>
        </section>
      </div>
    </div>
