...
export async function generateMetadata({
  ...
  const title = isDE
    ? "IT Security Birmingham 2026 — GDPR & UK Data Protection Act"
    : "IT Security Birmingham 2026 — GDPR & UK Data Protection Act";
  const description = isDE
    ? "IT Security Birmingham: GDPR, UK Data Protection Act, ISO 27001, Cyber Essentials für Birmingham Unternehmen. Enterprise Security Compliance."
    : "IT Security Birmingham: GDPR, UK Data Protection Act, ISO 27001, Cyber Essentials for Birmingham companies. Enterprise security compliance.";

  return {
    title,
    description,
    keywords: [
      "IT Security Birmingham",
      "GDPR Birmingham",
      "UK Data Protection Act",
      "ISO 27001 Birmingham",
      "Cyber Essentials",
      "Cybersecurity Birmingham",
      "Enterprise Security",
      "Compliance Birmingham",
    ],
    alternates: buildLocalizedAlternates(locale, "/it-security/birmingham"),
    openGraph: {
      images: ["/og-image.png"],
      title,
      description,
      type: "article",
      url: `${BASE_URL}/${locale}/it-security/birmingham`,
    },
  };
}

export default function BirminghamITSecurityPage({
  params,
}: {
  params: { lang: string };
}) {
  ...
  const subtitle = isDE
    ? "Enterprise Security für Birmingham Unternehmen"
    : "Enterprise Security for Birmingham Companies";

  const description = isDE
    ? "Birmingham ist ein Tech-Hub mit strengen Datenschutzanforderungen. GDPR, UK Data Protection Act, ISO 27001 und Cyber Essentials sind für Birmingham Unternehmen essenziell. ClawGuru hilft bei der Compliance-Umsetzung."
    : "Birmingham is a tech hub with strict data protection requirements. GDPR, UK Data Protection Act, ISO 27001, and Cyber Essentials are essential for Birmingham companies. ClawGuru helps with compliance implementation.";
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-gray-100">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {/* Birmingham-Specific Compliance Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Birmingham-Spezifische Compliance" : "Birmingham-Specific Compliance"}
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "General Data Protection Regulation gilt EU-weit und im UK. Birmingham Unternehmen müssen GDPR-konform operieren."
                  : "General Data Protection Regulation applies EU-wide and in the UK. Birmingham companies must operate GDPR-compliant."}
              </p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "ISO 27001 Zertifizierung zeigt Informationssicherheit-Management für Birmingham Kunden."
                  : "ISO 27001 certification demonstrates information security management for Birmingham customers."}
              </p>
            </div>
          </div>
        </section>

        {/* Birmingham Tech Hub Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Birmingham Tech-Ökosystem" : "Birmingham Tech Ecosystem"}
          </h3>
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-2">
                ...
                {isDE
                  ? "Startups & Scaleups: Funding Circle, GoCardless, Paddle, Thought Machine"
                  : "Startups & Scaleups: Funding Circle, GoCardless, Paddle, Thought Machine"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Enterprise: Jaguar Land Rover, National Grid, Severn Trent, Cadbury"
                  : "Enterprise: Jaguar Land Rover, National Grid, Severn Trent, Cadbury"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Research: University of Birmingham, Aston University, Birmingham Tech"
                  : "Research: University of Birmingham, Aston University, Birmingham Tech"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Government: Birmingham City Council, NCSC Midlands, ICO"
                  : "Government: Birmingham City Council, NCSC Midlands, ICO"}
              </li>
            </ul>
          </div>
        ...
        <div className="mb-8">
          <InteractiveChecklist
            slug="birmingham-it-security"
            title={isDE ? "Birmingham IT Security Checklist" : "Birmingham IT Security Checklist"}
            items={[
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">
            {isDE ? "Birmingham IT Security Assessment" : "Birmingham IT Security Assessment"}
          </h2>
