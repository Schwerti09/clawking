...
export async function generateMetadata({
  ...
  const title = isDE
    ? "IT Security Mumbai 2026 — DPDP Act & CERT-In"
    : "IT Security Mumbai 2026 — DPDP Act & CERT-In";
  const description = isDE
    ? "IT Security Mumbai: DPDP Act (Digital Personal Data Protection Act), CERT-In Guidelines, ISO 27001 für Mumbai Unternehmen. Enterprise Security Compliance."
    : "IT Security Mumbai: DPDP Act (Digital Personal Data Protection Act), CERT-In Guidelines, ISO 27001 for Mumbai companies. Enterprise security compliance.";
  ...
  return {
    ...
    alternates: buildLocalizedAlternates(locale, "/it-security/mumbai"),
    openGraph: {
      images: ["/og-image.png"],
      title,
      description,
      type: "article",
      url: `${BASE_URL}/${locale}/it-security/mumbai`,
    },
  };
}

export default function MumbaiITSecurityPage({
  params,
}: {
  params: { lang: string };
}) {
  ...
  const subtitle = isDE
    ? "Enterprise Security für Mumbai Unternehmen"
    : "Enterprise Security for Mumbai Companies";

  const description = isDE
    ? "Mumbai ist ein Tech-Hub mit strengen Datenschutzanforderungen. DPDP Act, CERT-In-Richtlinien und ISO 27001 sind für Mumbai Unternehmen essenziell. ClawGuru hilft bei der Compliance-Umsetzung."
    : "Mumbai is a tech hub with strict data protection requirements. DPDP Act, CERT-In guidelines, and ISO 27001 are essential for Mumbai companies. ClawGuru helps with compliance implementation.";
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-gray-100">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {/* Mumbai-Specific Compliance Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Mumbai-Spezifische Compliance" : "Mumbai-Specific Compliance"}
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "ISO 27001 Zertifizierung zeigt Informationssicherheit-Management für Mumbai Kunden."
                  : "ISO 27001 certification demonstrates information security management for Mumbai customers."}
              </p>
            </div>
          </div>
        </section>

        {/* Mumbai Tech Hub Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Mumbai Tech-Ökosystem" : "Mumbai Tech Ecosystem"}
          </h3>
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-2">
                ...
                {isDE
                  ? "Startups & Scaleups: Zerodha, PolicyBazaar, Freshworks, Lendingkart"
                  : "Startups & Scaleups: Zerodha, PolicyBazaar, Freshworks, Lendingkart"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Enterprise: Tata Group, Reliance Industries, HDFC Bank, L&T"
                  : "Enterprise: Tata Group, Reliance Industries, HDFC Bank, L&T"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Research: IIT Bombay, Tata Institute of Fundamental Research, BARC"
                  : "Research: IIT Bombay, Tata Institute of Fundamental Research, BARC"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
        ...
        <div className="mb-8">
          <InteractiveChecklist
            slug="mumbai-it-security"
            title={isDE ? "Mumbai IT Security Checklist" : "Mumbai IT Security Checklist"}
            items={[
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">
            {isDE ? "Mumbai IT Security Assessment" : "Mumbai IT Security Assessment"}
          </h2>
