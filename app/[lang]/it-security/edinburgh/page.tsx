...
export async function generateMetadata({
  ...
  const title = isDE
    ? "IT Security Edinburgh 2026 — GDPR & UK Data Protection Act"
    : "IT Security Edinburgh 2026 — GDPR & UK Data Protection Act";
  const description = isDE
    ? "IT Security Edinburgh: GDPR, UK Data Protection Act, ISO 27001, Cyber Essentials für Edinburgh Unternehmen. Enterprise Security Compliance."
    : "IT Security Edinburgh: GDPR, UK Data Protection Act, ISO 27001, Cyber Essentials for Edinburgh companies. Enterprise security compliance.";

  return {
    title,
    description,
    keywords: [
      "IT Security Edinburgh",
      "GDPR Edinburgh",
      ...
      "Enterprise Security",
      "Compliance Edinburgh",
    ],
    alternates: buildLocalizedAlternates(locale, "/it-security/edinburgh"),
    openGraph: {
      images: ["/og-image.png"],
      title,
      description,
      type: "article",
      url: `${BASE_URL}/${locale}/it-security/edinburgh`,
    },
  };
}

export default function EdinburghITSecurityPage({
  params,
}: {
  params: { lang: string };
}) {
  ...
  const subtitle = isDE
    ? "Enterprise Security für Edinburgh Unternehmen"
    : "Enterprise Security for Edinburgh Companies";

  const description = isDE
    ? "Edinburgh ist ein Tech-Hub mit strengen Datenschutzanforderungen. GDPR, UK Data Protection Act, ISO 27001 und Cyber Essentials sind für Edinburgh Unternehmen essenziell. ClawGuru hilft bei der Compliance-Umsetzung."
    : "Edinburgh is a tech hub with strict data protection requirements. GDPR, UK Data Protection Act, ISO 27001, and Cyber Essentials are essential for Edinburgh companies. ClawGuru helps with compliance implementation.";
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-gray-100">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {/* Edinburgh-Specific Compliance Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Edinburgh-Spezifische Compliance" : "Edinburgh-Specific Compliance"}
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "General Data Protection Regulation gilt EU-weit und im UK. Edinburgh Unternehmen müssen GDPR-konform operieren."
                  : "General Data Protection Regulation applies EU-wide and in the UK. Edinburgh companies must operate GDPR-compliant."}
              </p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "ISO 27001 Zertifizierung zeigt Informationssicherheit-Management für Edinburgh Kunden."
                  : "ISO 27001 certification demonstrates information security management for Edinburgh customers."}
              </p>
            </div>
          </div>
        </section>

        {/* Edinburgh Tech Hub Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Edinburgh Tech-Ökosystem" : "Edinburgh Tech Ecosystem"}
          </h3>
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-2">
                ...
                {isDE
                  ? "Startups & Scaleups: Skyscanner, FanDuel, FreeAgent, CareTech"
                  : "Startups & Scaleups: Skyscanner, FanDuel, FreeAgent, CareTech"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Enterprise: Royal Bank of Scotland, Standard Life, Baillie Gifford, SSE"
                  : "Enterprise: Royal Bank of Scotland, Standard Life, Baillie Gifford, SSE"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Research: University of Edinburgh, Heriot-Watt, Roslin"
                  : "Research: University of Edinburgh, Heriot-Watt, Roslin"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Government: Scottish Government, NCSC Scotland, ICO"
                  : "Government: Scottish Government, NCSC Scotland, ICO"}
              </li>
            </ul>
          </div>
        ...
        <div className="mb-8">
          <InteractiveChecklist
            slug="edinburgh-it-security"
            title={isDE ? "Edinburgh IT Security Checklist" : "Edinburgh IT Security Checklist"}
            items={[
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">
            {isDE ? "Edinburgh IT Security Assessment" : "Edinburgh IT Security Assessment"}
          </h2>
