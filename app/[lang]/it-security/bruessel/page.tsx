...
export async function generateMetadata({
  ...
  const title = isDE
    ? "IT Security Brüssel 2026 — DSGVO & GDPR"
    : "IT Security Brussels 2026 — GDPR & GDPR";
  const description = isDE
    ? "IT Security Brüssel: DSGVO, GDPR, ISO 27001, NBN ISO/IEC 27001 für Brüsseler Unternehmen. Enterprise Security Compliance."
    : "IT Security Brussels: GDPR, GDPR, ISO 27001, NBN ISO/IEC 27001 for Brussels companies. Enterprise security compliance.";
  ...
  return {
    ...
    keywords: [
      ...
      "NBN ISO/IEC 27001",
      "ISO 27001 Brüssel",
      "Cybersecurity Brüssel",
      "Enterprise Security",
      "Compliance Brüssel",
    ],
    alternates: buildLocalizedAlternates(locale, "/it-security/bruessel"),
    openGraph: {
      images: ["/og-image.png"],
      title,
      description,
      type: "article",
      url: `${BASE_URL}/${locale}/it-security/bruessel`,
    },
  };
}

export default function BruesselITSecurityPage({
  params,
}: {
  params: { lang: string };
}) {
  ...
  const subtitle = isDE
    ? "Enterprise Security für Brüsseler Unternehmen"
    : "Enterprise Security for Brussels Companies";

  const description = isDE
    ? "Brüssel ist ein Tech-Hub mit strengen Datenschutzanforderungen. DSGVO, GDPR, NBN ISO/IEC 27001 und ISO 27001 sind für Brüsseler Unternehmen essenziell. ClawGuru hilft bei der Compliance-Umsetzung."
    : "Brussels is a tech hub with strict data protection requirements. GDPR, GDPR, NBN ISO/IEC 27001, and ISO 27001 are essential for Brussels companies. ClawGuru helps with compliance implementation.";
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-gray-100">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {/* Brüssel-Specific Compliance Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Brüssel-Spezifische Compliance" : "Brussels-Specific Compliance"}
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "Datenschutz-Grundverordnung gilt EU-weit. Brüsseler Unternehmen müssen DSGVO-konform operieren."
                  : "General Data Protection Regulation applies EU-wide. Brussels companies must operate GDPR-compliant."}
              </p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "ISO 27001 Zertifizierung zeigt Informationssicherheit-Management für Brüsseler Kunden."
                  : "ISO 27001 certification demonstrates information security management for Brussels customers."}
              </p>
            </div>
          </div>
        </section>

        {/* Brüssel Tech Hub Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Brüsseler Tech-Ökosystem" : "Brussels Tech Ecosystem"}
          </h3>
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-2">
                ...
                {isDE
                  ? "Startups & Scaleups: Collibra, Showpad, Odoo, Teamleader"
                  : "Startups & Scaleups: Collibra, Showpad, Odoo, Teamleader"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Enterprise: BNP Paribas Fortis, Proximus, Solvay, Bpost"
                  : "Enterprise: BNP Paribas Fortis, Proximus, Solvay, Bpost"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Research: Vrije Universiteit Brussel, ULB, imec"
                  : "Research: Vrije Universiteit Brussel, ULB, imec"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Government: EU Institutions, Belgian Government, APD"
                  : "Government: EU Institutions, Belgian Government, APD"}
              </li>
            </ul>
          </div>
        ...
        <div className="mb-8">
          <InteractiveChecklist
            slug="bruessel-it-security"
            title={isDE ? "Brüssel IT Security Checklist" : "Brussels IT Security Checklist"}
            items={[
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">
            {isDE ? "Brüssel IT Security Assessment" : "Brussels IT Security Assessment"}
          </h2>
