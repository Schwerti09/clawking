...
export async function generateMetadata({
  ...
  const title = isDE
    ? "IT Security Bristol 2026 — GDPR & UK Data Protection Act"
    : "IT Security Bristol 2026 — GDPR & UK Data Protection Act";
  const description = isDE
    ? "IT Security Bristol: GDPR, UK Data Protection Act, ISO 27001, Cyber Essentials für Bristol Unternehmen. Enterprise Security Compliance."
    : "IT Security Bristol: GDPR, UK Data Protection Act, ISO 27001, Cyber Essentials for Bristol companies. Enterprise security compliance.";
  ...
  return {
    ...
    alternates: buildLocalizedAlternates(locale, "/it-security/bristol"),
    openGraph: {
      images: ["/og-image.png"],
      title,
      description,
      type: "article",
      url: `${BASE_URL}/${locale}/it-security/bristol`,
    },
  };
}

export default function BristolITSecurityPage({
  params,
}: {
  params: { lang: string };
}) {
  ...
  const subtitle = isDE
    ? "Enterprise Security für Bristol Unternehmen"
    : "Enterprise Security for Bristol Companies";

  const description = isDE
    ? "Bristol ist ein Tech-Hub mit strengen Datenschutzanforderungen. GDPR, UK Data Protection Act, ISO 27001 und Cyber Essentials sind für Bristol Unternehmen essenziell. ClawGuru hilft bei der Compliance-Umsetzung."
    : "Bristol is a tech hub with strict data protection requirements. GDPR, UK Data Protection Act, ISO 27001, and Cyber Essentials are essential for Bristol companies. ClawGuru helps with compliance implementation.";
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-gray-100">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {/* Bristol-Specific Compliance Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Bristol-Spezifische Compliance" : "Bristol-Specific Compliance"}
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "General Data Protection Regulation gilt EU-weit und im UK. Bristol Unternehmen müssen GDPR-konform operieren."
                  : "General Data Protection Regulation applies EU-wide and in the UK. Bristol companies must operate GDPR-compliant."}
              </p>
            </div>
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
              ...
              <p className="text-sm text-gray-300">
                {isDE
                  ? "ISO 27001 Zertifizierung zeigt Informationssicherheit-Management für Bristol Kunden."
                  : "ISO 27001 certification demonstrates information security management for Bristol customers."}
              </p>
            </div>
          </div>
        </section>

        {/* Bristol Tech Hub Context */}
        <section className="mb-16">
          <h3 className="text-2xl font-bold text-gray-100 mb-6">
            {isDE ? "Bristol Tech-Ökosystem" : "Bristol Tech Ecosystem"}
          </h3>
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-2">
                ...
                {isDE
                  ? "Startups & Scaleups: Graphcore, Immersive Labs, Ultraleap, OVO Energy"
                  : "Startups & Scaleups: Graphcore, Immersive Labs, Ultraleap, OVO Energy"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Enterprise: Airbus Bristol, Rolls-Royce, Dyson, Babcock"
                  : "Enterprise: Airbus Bristol, Rolls-Royce, Dyson, Babcock"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Research: University of Bristol, UWE Bristol, Bristol Robotics"
                  : "Research: University of Bristol, UWE Bristol, Bristol Robotics"}
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span>
                {isDE
                  ? "Government: Bristol City Council, NCSC South West, ICO"
                  : "Government: Bristol City Council, NCSC South West, ICO"}
              </li>
            </ul>
          </div>
        ...
        <div className="mb-8">
          <InteractiveChecklist
            slug="bristol-it-security"
            title={isDE ? "Bristol IT Security Checklist" : "Bristol IT Security Checklist"}
            items={[
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-center text-white">
          <h2 className="text-2xl font-bold mb-4">
            {isDE ? "Bristol IT Security Assessment" : "Bristol IT Security Assessment"}
          </h2>
