      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">RabbitMQ TLS Configuration</h2>
...
listeners.tcp = none`}
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">OAuth 2.0 / OIDC Integration</h2>
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <pre className="font-mono text-sm text-green-400">
...
oauth2.signing_keys = RS256 RS384 RS512`}
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">Management UI Security</h2>
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <pre className="font-mono text-sm text-green-400">
...
management.clickjacking_protection = true`}
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">Resource Limits & DoS Protection</h2>
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <pre className="font-mono text-sm text-green-400">
...
tcp_listen_options.recbuf = 196608`}
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">Policy-Based Authorization</h2>
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <pre className="font-mono text-sm text-green-400">
  ...
  "topic_permissions": [
    {
      ...
      "read": "^$"
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">Federation & Shovel Security</h2>
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <pre className="font-mono text-sm text-green-400">
...
ssl_options.keyfile = /etc/rabbitmq/ssl/federation.key`}
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">Security Best Practices Checklist</h2>
            <div className="bg-gray-800 border border-slate-200 rounded-xl p-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="font-semibold text-gray-100 mb-4">Authentication & Authorization</h3>
                  {[
