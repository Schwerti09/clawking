...
export default function HipaaSecurityControlsPage({ params }: PageProps) {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: [
      { '@type': 'Question', name: locale === 'de' ? 'Was sind die technischen HIPAA Safeguards?' : 'What are the HIPAA technical safeguards?', acceptedAnswer: { '@type': 'Answer', text: locale === 'de' ? 'HIPAA Technical Safeguards (45 CFR § 164.312): Access Control (eindeutige User-IDs, automatischer Logout), Audit Controls (Aktivitäts-Logs für PHI-Zugriff), Integrity (keine unautorisierte PHI-Änderung), Transmission Security (TLS für alle PHI-Übertragungen). PHI = Protected Health Information.' : 'HIPAA Technical Safeguards (45 CFR § 164.312): Access Control (unique user IDs, automatic logout), Audit Controls (activity logs for PHI access), Integrity (no unauthorized PHI modification), Transmission Security (TLS for all PHI transmissions). PHI = Protected Health Information.' } },
      { '@type': 'Question', name: locale === 'de' ? 'Was ist ein Business Associate Agreement (BAA) unter HIPAA?' : 'What is a Business Associate Agreement (BAA) under HIPAA?', acceptedAnswer: { '@type': 'Answer', text: locale === 'de' ? 'Ein BAA ist ein Vertrag zwischen einer Covered Entity (Krankenhaus, Arztpraxis) und einem Business Associate (Cloud-Provider, Software-Vendor) der PHI verarbeitet. Pflicht unter HIPAA: AWS, Google Cloud, Azure bieten BAAs. Ohne BAA: Keine PHI in diesen Cloud-Diensten speichern. AWS HIPAA-eligible Services: RDS, S3, EC2, DynamoDB, Lambda.' : 'A BAA is a contract between a covered entity (hospital, doctor office) and a business associate (cloud provider, software vendor) that processes PHI. Required under HIPAA: AWS, Google Cloud, Azure offer BAAs. Without BAA: do not store PHI in these cloud services. AWS HIPAA-eligible services: RDS, S3, EC2, DynamoDB, Lambda.' } },
      { '@type': 'Question', name: locale === 'de' ? 'Wie führe ich ein HIPAA Risk Assessment durch?' : 'How do I conduct a HIPAA risk assessment?', acceptedAnswer: { '@type': 'Answer', text: locale === 'de' ? 'HIPAA Risk Assessment Schritte: PHI-Inventar erstellen (wo liegt PHI?), Bedrohungen identifizieren (Ransomware, Insider, Datenpannen), Wahrscheinlichkeit und Impact bewerten, bestehende Kontrollen erfassen, Residualrisiko berechnen, Risikobehandlungsplan erstellen. Jährlich wiederholen oder bei wesentlichen Änderungen. Dokumentation für Audits aufbewahren.' : 'HIPAA Risk Assessment steps: create PHI inventory (where is PHI?), identify threats (ransomware, insider, breaches), assess likelihood and impact, document existing controls, calculate residual risk, create risk treatment plan. Repeat annually or at material changes. Retain documentation for audits.' } },
      { '@type': 'Question', name: locale === 'de' ? 'Was sind die HIPAA Breach Notification Anforderungen?' : 'What are the HIPAA breach notification requirements?', acceptedAnswer: { '@type': 'Answer', text: locale === 'de' ? 'HIPAA Breach Notification Rule: Betroffene Individuen innerhalb 60 Tagen benachrichtigen. HHS (Department of Health & Human Services) innerhalb 60 Tagen. Bei > 500 Betroffenen in einem State: lokale Medien benachrichtigen. Kleiner Breaches (< 500): jährlicher HHS-Bericht. Breach Definition: ungesicherter PHI-Zugriff ohne Ausnahme (z.B. Encryption Safe Harbor).' : 'HIPAA Breach Notification Rule: notify affected individuals within 60 days. HHS (Department of Health & Human Services) within 60 days. For > 500 affected in a state: notify local media. Small breaches (< 500): annual HHS report. Breach definition: unsecured PHI access without exception (e.g. encryption safe harbor).' } },
    ],
  }
