...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  const title = isDE
    ? "HIPAA AI Compliance: HIPAA-KI-Compliance für Self-Hosted AI | ClawGuru Solutions"
    : "HIPAA AI Compliance: HIPAA Compliance for Self-Hosted AI Systems | ClawGuru Solutions"
  const description = isDE
    ? "HIPAA-Compliance für KI-Systeme: PHI-Schutz, Access Controls, Audit Logging und Breach Notification für Self-Hosted AI und LLM-Systeme im Healthcare-Bereich."
    : "HIPAA compliance for AI systems: PHI protection, access controls, audit logging and breach notification for self-hosted AI and LLM systems in healthcare."
  return {
    title, description,
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-amber-900 border-l-4 border-amber-500 p-4 mb-8 text-sm text-amber-100">
          <strong className="text-amber-100">"Not a Pentest" Notice</strong>: {isDE ? "HIPAA-Compliance-Guide für eigene KI-Systeme im Healthcare-Bereich." : "HIPAA compliance guide for your own AI systems in healthcare."}
        </div>
        <div className="mb-3"><span className="text-xs font-bold uppercase tracking-widest text-cyan-400">Solutions · Batch 9</span></div>
        <h1 className="text-4xl font-bold mb-4 text-gray-100">{isDE ? "HIPAA AI Compliance" : "HIPAA AI Compliance"}</h1>
        <p className="text-lg text-gray-300 mb-6">
          {isDE
            ? "KI-Systeme im Healthcare-Bereich müssen HIPAA einhalten — PHI-Schutz, Technical Safeguards, Minimum Necessary Standard und Breach Notification sind nicht optional. Vier Kontrollen für HIPAA-konforme AI-Systeme."
            : "AI systems in healthcare must comply with HIPAA — PHI protection, technical safeguards, minimum necessary standard and breach notification are not optional. Four controls for HIPAA-compliant AI systems."}
        </p>
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">{isDE ? "4 HIPAA-Compliance-Kontrollen für KI" : "4 HIPAA Compliance Controls for AI"}</h2>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <a href={`/${locale}/solutions/gdpr-breach-notification-ai`} className="block bg-gray-800 p-4 rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors">
              ...
              <div className="text-sm text-gray-300">{isDE ? "GDPR-Compliance" : "GDPR compliance"}</div>
            </a>
