    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-amber-900 border-l-4 border-amber-500 p-4 mb-8 text-sm text-amber-100">
          <strong className="text-amber-100">"Not a Pentest" Notice</strong>: {pick(isDE, "Federated-Inference-Guide für eigene KI-Systeme.", "Federated inference guide for your own AI systems.")}
        </div>
        <div className="mb-3"><span className="text-xs font-bold uppercase tracking-widest text-cyan-400">Moltbot · Batch 23</span></div>
        <h1 className="text-4xl font-bold mb-4 text-gray-100">{pick(isDE, "LLM Federated Inference", "LLM Federated Inference")}</h1>
        <p className="text-lg text-gray-300 mb-6">
          {pick(isDE, "LLM-Modelle ohne Federated-Inference sind skaliert und ungeschützt — ohne Federated-Inference bleibt Inference zentralisiert. Vier Kontrollen: Distributed Inference, Model Sharding, Inference Aggregation und Privacy-Preserving Inference.", "LLM models without federated inference are centralised and unprotected — without federated inference, inference remains centralised. Four controls: distributed inference, model sharding, inference aggregation and privacy-preserving inference.")}
        </p>
