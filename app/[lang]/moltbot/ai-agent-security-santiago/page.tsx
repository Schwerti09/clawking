...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = isDE
    ? "AI Agent Security Santiago: DP Law, Zero-Trust, Moltbot | ClawGuru"
    : "AI Agent Security Santiago: DP Law, Zero-Trust, Moltbot | ClawGuru"
  const description = isDE
    ? "Santiago Security Guide für AI-Agents: Datenschutz-Compliance, Zero-Trust und schnelle Fixes für Moltbot."
    : "Santiago security guide for AI agents: data protection compliance, zero-trust and fast fixes for Moltbot."
  return {
    title,
    description,
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">{isDE ? "AI Agent Security Santiago" : "AI Agent Security Santiago"}</h1>
          <p className="text-lg text-gray-300 mb-4">
            {isDE
              ? "Santiago Playbook für AI-Agent-Security: Datenschutz, Zero-Trust und schnelle Fixes für Moltbot."
              : "Santiago playbook for AI agent security: data protection, zero-trust and fast fixes for Moltbot."}
          </p>
        </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">{isDE ? "Santiago Fokus" : "Santiago focus"}</h2>
          <div className="space-y-4">
            {[
              [isDE ? "Data Protection Law" : "Data protection law", isDE ? "Datenschutzanforderungen sauber abbilden und dokumentieren." : "Map and document privacy requirements cleanly."],
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              ...
              [4, isDE ? "Audit Logs an SIEM" : "Audit logs to SIEM", isDE ? "Compliance-konforme Nachverfolgbarkeit." : "Compliance-grade traceability."],
            ].map(([n, t, d]) => (
