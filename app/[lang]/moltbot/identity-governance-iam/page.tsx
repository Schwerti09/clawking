...
scheduleJob('0 2 * * *', runAccessReviews); // Jeden Tag um 2 Uhr`}</pre>
        ...
        <section className="mb-10">
          ...
          <p className="text-lg text-gray-600 mb-8">Additional resources to help you implement Identity Governance and IAM in your organization.</p>
          <ul>
            <li><a href="https://clawguru.org/docs/identity-governance">Identity Governance Documentation</a></li>
            <li><a href="https://clawguru.org/docs/iam">IAM Documentation</a></li>
            <li><a href="https://clawguru.org/blog/identity-governance-best-practices">Identity Governance Best Practices</a></li>
            <li><a href="https://clawguru.org/blog/iam-best-practices">IAM Best Practices</a></li>
          </ul>
        </section>
      </div>
    </div>
