    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-8 text-sm">
          <strong>"Not a Pentest" Trust-Anker</strong>: RASP schützt eigene Anwendungen zur Laufzeit. Keine Angriffswerkzeuge.
        </div>
        <h1 className="text-4xl font-bold mb-4">Moltbot Runtime Protection RASP</h1>
        <p className="text-lg text-gray-600 mb-8">Runtime Application Self-Protection ist die letzte Verteidigungslinie. Anwendungen, die sich selbst schützen können, reduzieren Attack Surface um 70%.</p>

        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4">RASP Protection Layers</h2>
