      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">
            {pick(isDE, "AI Agent Observability Security", "AI Agent Observability Security")}
          </h1>
          <p className="text-lg text-gray-300 mb-4">
            {pick(isDE, "AI Agent Observability Security für Moltbot. Metrics, Traces, Logs und Security Events für AI-Agents. OpenTelemetry, SIEM-Integration und Anomaly Detection in Echtzeit.", "AI agent observability security for Moltbot. Metrics, traces, logs and security events for AI agents. OpenTelemetry, SIEM integration and real-time anomaly detection.")}
          </p>
        </div>
