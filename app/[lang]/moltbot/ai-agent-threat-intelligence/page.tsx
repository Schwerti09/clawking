  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">{pick(isDE, "AI Agent Threat Intelligence", "AI Agent Threat Intelligence")}</h1>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            {[
              ["1. MITRE ATLAS Framework", pick(isDE, "MITRE ATLAS als Adversarial Threat Landscape für AI-Systeme. Taktiken, Techniken und Procedures spezifisch für AI-Angriffe.", "MITRE ATLAS as adversarial threat landscape for AI systems. Tactics, techniques and procedures specific to AI attacks.")],
              ["2. CTI-Integration", pick(isDE, "Integration von Cyber Threat Intelligence in AI-Agent-Abwehr. Automatisches Update von Bedrohungs-Indikatoren.", "Integration of Cyber Threat Intelligence in AI agent defense. Automatic update of threat indicators.")],
              ["3. IOC Feeds", pick(isDE, "Indicators of Compromise für AI-spezifische Angriffe. Malicious Prompts, bekannte Jailbreak-Patterns und Adversarial Examples.", "Indicators of Compromise for AI-specific attacks. Malicious prompts, known jailbreak patterns and adversarial examples.")],
              ["4. Threat Hunting für AI", pick(isDE, "Proaktive Suche nach Bedrohungen in AI-Agent-Systemen. Hypothesen-basiertes Hunting nach ATLAS-Techniken.", "Proactive threat hunting in AI agent systems. Hypothesis-based hunting for ATLAS techniques.")],
              ["5. Vulnerability Intelligence", pick(isDE, "Kontinuierliches Monitoring von AI-relevanten CVEs und Schwachstellen. Automatische Benachrichtigung bei neuen Findings.", "Continuous monitoring of AI-relevant CVEs and vulnerabilities. Automatic notification on new findings.")],
            ].map(([t, d]) => (
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              [1, pick(isDE, "MITRE ATLAS studieren", "Study MITRE ATLAS"), pick(isDE, "ATLAS-Taktiken auf eigene AI-Agent-Architektur mappen. Welche Techniken sind relevant?", "Map ATLAS tactics to your own AI agent architecture. Which techniques are relevant?")],
              [2, pick(isDE, "CTI-Feed abonnieren", "Subscribe to CTI feed"), pick(isDE, "AI-spezifische Threat Intelligence Feeds abonnieren. CISA, AI Security Alliance, MITRE.", "Subscribe to AI-specific threat intelligence feeds. CISA, AI Security Alliance, MITRE.")],
              [3, pick(isDE, "IOC-Matching automatisieren", "Automate IOC matching"), pick(isDE, "Eingehende Requests gegen bekannte Malicious Patterns matchen. Echtzeit-Blocking bei Match.", "Match incoming requests against known malicious patterns. Real-time blocking on match.")],
              [4, pick(isDE, "Threat Hunting durchführen", "Conduct threat hunting"), pick(isDE, "Regelmäßige Threat Hunting Sessions für AI-Systeme. ATLAS-basierte Hunting Queries.", "Regular threat hunting sessions for AI systems. ATLAS-based hunting queries.")],
              [5, pick(isDE, "Intelligence teilen", "Share intelligence"), pick(isDE, "Eigene Findings in Threat Intelligence Communities teilen. ISAC-Mitgliedschaft für AI-Security.", "Share own findings in threat intelligence communities. ISAC membership for AI security.")],
            ].map(([n, t, d]) => (
