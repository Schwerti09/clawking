...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = isDE
    ? "AI Agent Security Bangalore: DPDP, Zero-Trust, Moltbot | ClawGuru"
    : "AI Agent Security Bangalore: DPDP, Zero-Trust, Moltbot | ClawGuru"
  const description = isDE
    ? "Bangalore Security Guide für AI-Agents: DPDP-Compliance, Zero-Trust und sofortige Fixes für Moltbot."
    : "Bangalore security guide for AI agents: DPDP compliance, zero-trust and immediate fixes for Moltbot."
  return {
    title,
    description,
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">{isDE ? "AI Agent Security Bangalore" : "AI Agent Security Bangalore"}</h1>
          <p className="text-lg text-gray-300 mb-4">
            {isDE
              ? "Bangalore Playbook für AI-Agent-Security: DPDP, Zero-Trust und schnelle Fixes für Moltbot."
              : "Bangalore playbook for AI agent security: DPDP, zero-trust and fast fixes for Moltbot."}
          </p>
        </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">{isDE ? "Bangalore Fokus" : "Bangalore focus"}</h2>
          <div className="space-y-4">
            {[
              [isDE ? "DPDP Compliance" : "DPDP compliance", isDE ? "Datenzugriff, Processing und Retention nach DPDP ausrichten." : "Align data access, processing and retention with DPDP."],
              [isDE ? "B2B SaaS Exposure" : "B2B SaaS exposure", isDE ? "Viele Integrationen mit SaaS-Providern: Allowlist und JIT Access." : "Many SaaS integrations: allowlist and JIT access."],
              [isDE ? "Supply Chain Risk" : "Supply chain risk", isDE ? "Dependencies und Modelle vor Produktion härten." : "Harden dependencies and models before production."],
              [isDE ? "Incident Ownership" : "Incident ownership", isDE ? "Playbooks und Verantwortlichkeiten glasklar definieren." : "Define playbooks and responsibilities clearly."],
            ].map(([t, d]) => (
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              ...
              [4, isDE ? "Audit Logs an SIEM" : "Audit logs to SIEM", isDE ? "DPDP-konforme Nachverfolgbarkeit sicherstellen." : "Ensure DPDP-compliant traceability."],
            ].map(([n, t, d]) => (
