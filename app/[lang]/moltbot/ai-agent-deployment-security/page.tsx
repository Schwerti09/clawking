      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">
            {pick(isDE, "AI Agent Deployment Security", "AI Agent Deployment Security")}
          </h1>
          <p className="text-lg text-gray-300 mb-4">
            {pick(isDE, "AI Agent Deployment Security für Moltbot. Sichere CI/CD-Pipelines, Container Hardening, Secrets Management und Blue/Green Deployments für AI-Agent-Systeme.", "AI agent deployment security for Moltbot. Secure CI/CD pipelines, container hardening, secrets management and blue/green deployments for AI agent systems.")}
          </p>
        </div>
