...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = pick(isDE, "AI Agent Security Jakarta: PDP Law, Zero-Trust, Moltbot | ClawGuru", "AI Agent Security Jakarta: PDP Law, Zero-Trust, Moltbot | ClawGuru")
  const description = pick(isDE, "Jakarta Security Guide für AI-Agents: PDP Law, Zero-Trust und schnelle Fixes für Moltbot.", "Jakarta security guide for AI agents: PDP Law, zero-trust and fast fixes for Moltbot.")
  return {
    title,
    description,
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">{pick(isDE, "AI Agent Security Jakarta", "AI Agent Security Jakarta")}</h1>
          <p className="text-lg text-gray-300 mb-4">
            {pick(isDE, "Jakarta Playbook für AI-Agent-Security: PDP Law, Zero-Trust und schnelle Fixes für Moltbot.", "Jakarta playbook for AI agent security: PDP Law, zero-trust and fast fixes for Moltbot.")}
          </p>
        </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">{pick(isDE, "Jakarta Fokus", "Jakarta focus")}</h2>
          <div className="space-y-4">
            {[
              [pick(isDE, "PDP Law Compliance", "PDP Law compliance"), pick(isDE, "Datenzugriff und Retention PDP-konform dokumentieren.", "Document data access and retention per PDP law.")],
              [pick(isDE, "FinTech Exposure", "FinTech exposure"), pick(isDE, "Payment-Integrationen nur per Allowlist.", "Allowlist-only payment integrations.")],
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              ...
              [4, pick(isDE, "Audit Logs an SIEM", "Audit logs to SIEM"), pick(isDE, "PDP-konforme Nachverfolgbarkeit sichern.", "Ensure PDP-compliant traceability.")],
            ].map(([n, t, d]) => (
