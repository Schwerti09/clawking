    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-amber-900 border-l-4 border-amber-500 p-4 mb-8 text-sm text-amber-100">
          <strong className="text-amber-100">"Not a Pentest" Notice</strong>: This guide is for security architecture decisions. No attack tools.
        </div>
        <h1 className="text-4xl font-bold mb-4 text-gray-100">AI Agent Threat Modeling: Security Framework</h1>
        <p className="text-lg text-gray-300 mb-8">Complete AI agent threat modeling framework with attack vectors, security controls, and protection strategies for autonomous systems.</p>

        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">AI Agent Security Overview</h2>
          <div className="bg-gray-800 p-4 rounded-lg mb-4 border border-gray-700">
            <h3 className="font-semibold mb-2 text-gray-100">Unique AI Agent Challenges</h3>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">AI Agent Threat Categories</h2>
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-cyan-400 mb-3">External Threats</h3>
              ...
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-cyan-400 mb-3">Internal Threats</h3>
                <ul className="space-y-2 text-sm text-gray-300">
...
- Mitigation strategy selection`}
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-green-400 mb-3">Preventive Controls</h3>
                <ul className="space-y-2 text-sm text-gray-300">
              ...
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-green-400 mb-3">Detective Controls</h3>
                <ul className="space-y-2 text-sm text-gray-300">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-green-400 mb-3">Corrective Controls</h3>
                <ul className="space-y-2 text-sm text-gray-300">
              ...
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-green-400 mb-3">Compensating Controls</h3>
                <ul className="space-y-2 text-sm text-gray-300">
...
- Forensic analysis capabilities`}
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-purple-400 mb-3">Regulatory Compliance</h3>
                <ul className="space-y-2 text-sm text-gray-300">
              ...
              <div className="bg-gray-900 p-4 rounded-lg border border-gray-600">
                <h3 className="font-bold text-purple-400 mb-3">Ethical Governance</h3>
                <ul className="space-y-2 text-sm text-gray-300">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-600 flex-1">
                  <div className="font-semibold text-gray-100">Security Testing</div>
                  <div className="text-sm text-gray-300">Penetration testing, vulnerability assessment, security scanning</div>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold flex-shrink-0">2</div>
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-600 flex-1">
                  <div className="font-semibold text-gray-100">AI-Specific Testing</div>
                  <div className="text-sm text-gray-300">Adversarial testing, robustness testing, safety testing</div>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold flex-shrink-0">3</div>
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-600 flex-1">
                  <div className="font-semibold text-gray-100">Performance Testing</div>
                  <div className="text-sm text-gray-300">Load testing, stress testing, scalability testing</div>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div className="bg-gray-900 p-4 rounded-lg border border-gray-600 flex-1">
                  <div className="font-semibold text-gray-100">Compliance Testing</div>
                  <div className="text-sm text-gray-300">Regulatory compliance, audit readiness, certification testing</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-900 p-4 rounded-lg border border-blue-700">
              <h3 className="font-semibold text-blue-300 mb-2">Design Principles</h3>
              <p className="text-sm text-blue-200">Security by design, defense in depth, least privilege, fail-safe defaults</p>
            </div>
            <div className="bg-green-900 p-4 rounded-lg border border-green-700">
              <h3 className="font-semibold text-green-300 mb-2">Development Practices</h3>
              <p className="text-sm text-green-200">Secure coding, code review, automated testing, dependency management</p>
            </div>
            <div className="bg-yellow-900 p-4 rounded-lg border border-yellow-700">
              <h3 className="font-semibold text-yellow-300 mb-2">Operational Practices</h3>
              <p className="text-sm text-yellow-200">Regular updates, patch management, backup procedures, disaster recovery</p>
            </div>
            <div className="bg-red-900 p-4 rounded-lg border border-red-700">
              <h3 className="font-semibold text-red-300 mb-2">Governance Practices</h3>
              <p className="text-sm text-red-200">Policy enforcement, compliance monitoring, risk management, audit trails</p>
            </div>
          </div>
        </section>
