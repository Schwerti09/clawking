...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = pick(isDE, "AI Agent Security Buenos Aires: PDPL, Zero-Trust, Moltbot | ClawGuru", "AI Agent Security Buenos Aires: PDPL, Zero-Trust, Moltbot | ClawGuru")
  const description = pick(isDE, "Buenos Aires Security Guide für AI-Agents: PDPL-Compliance, Zero-Trust und schnelle Fixes für Moltbot.", "Buenos Aires security guide for AI agents: PDPL compliance, zero-trust and fast fixes for Moltbot.")
  return {
    title,
    description,
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">{pick(isDE, "AI Agent Security Buenos Aires", "AI Agent Security Buenos Aires")}</h1>
          <p className="text-lg text-gray-300 mb-4">
            {pick(isDE, "Buenos Aires Playbook für AI-Agent-Security: PDPL, Zero-Trust und schnelle Fixes für Moltbot.", "Buenos Aires playbook for AI agent security: PDPL, zero-trust and fast fixes for Moltbot.")}
          </p>
        </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">{pick(isDE, "Buenos Aires Fokus", "Buenos Aires focus")}</h2>
          <div className="space-y-4">
            {[
              [pick(isDE, "PDPL Compliance", "PDPL compliance"), pick(isDE, "Datenschutzanforderungen sauber abbilden und dokumentieren.", "Map and document privacy requirements cleanly.")],
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              ...
              [4, pick(isDE, "Audit Logs an SIEM", "Audit logs to SIEM"), pick(isDE, "PDPL-konforme Nachverfolgbarkeit.", "PDPL-compliant traceability.")],
            ].map(([n, t, d]) => (
