      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">
            {pick(isDE, "AI Agent Context Security", "AI Agent Context Security")}
          </h1>
          <p className="text-lg text-gray-300 mb-4">
            {pick(isDE, "AI Agent Context Security für Moltbot. Context Window Isolation, Prompt Injection Prevention, Cross-Session Contamination und Kontext-Manipulation verhindern.", "AI agent context security for Moltbot. Context window isolation, prompt injection prevention, cross-session contamination and context manipulation prevention.")}
          </p>
        </div>
