...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://clawguru.org/${lang}/moltbot/security-automation-workflows`, languages: Object.fromEntries(LANGS.map(l => [l, `https://clawguru.org/${l}/moltbot/security-automation-workflows`])) },
    robots: 'index, follow',
  };
}

export default function MoltbotAutomationPage({ params }: PageProps) {
  const { lang } = params;
