    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-amber-900 border-l-4 border-amber-500 p-4 mb-8 text-sm text-amber-100">
          <strong className="text-amber-100">"Not a Pentest" Notice</strong>: {pick(isDE, "Halluzination-Detection-Guide für eigene KI-Systeme.", "Hallucination detection guide for your own AI systems.")}
        </div>
        <div className="mb-3"><span className="text-xs font-bold uppercase tracking-widest text-cyan-400">Moltbot · Batch 19</span></div>
        <h1 className="text-4xl font-bold mb-4 text-gray-100">{pick(isDE, "LLM Hallucination Detection", "LLM Hallucination Detection")}</h1>
        <p className="text-lg text-gray-300 mb-6">
          {pick(isDE, "LLM-Halluzinationen ohne Detection können zu falschen Informationen und Reputationsschäden führen. Vier Kontrollen: Fact-Checking Models, Consistency Verification, Confidence Scoring und Hallucination Mitigation.", "LLM hallucinations without detection can lead to misinformation and reputation damage. Four controls: fact-checking models, consistency verification, confidence scoring and hallucination mitigation.")}
        </p>
