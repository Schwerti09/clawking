...
<section className="mb-10">
  ...
  <ul className="list-disc pl-4 space-y-2">
    <li><a href="https://clawguru.org/de/security/redis-rate-limiting" target="_blank" rel="noopener noreferrer">Redis Rate Limiting Guide</a></li>
    <li><a href="https://clawguru.org/de/security/ddos-protection" target="_blank" rel="noopener noreferrer">DDoS Protection Strategies</a></li>
    <li><a href="https://clawguru.org/de/security/api-security" target="_blank" rel="noopener noreferrer">API Security Best Practices</a></li>
    <li><a href="https://clawguru.org/de/security/sliding-window" target="_blank" rel="noopener noreferrer">Sliding Window Algorithm</a></li>
  </ul>
</section>
</div>
</div>
