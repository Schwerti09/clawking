...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = isDE
    ? "AI Agent Security Singapore: PDPA, Zero-Trust, Moltbot | ClawGuru"
    : "AI Agent Security Singapore: PDPA, Zero-Trust, Moltbot | ClawGuru"
  const description = isDE
    ? "Singapore Security Guide für AI-Agents: PDPA-Compliance, Zero-Trust und schnelle Fixes für Moltbot-Deployments."
    : "Singapore security guide for AI agents: PDPA compliance, zero-trust and fast fixes for Moltbot deployments."
  return {
    title,
    description,
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-100">{isDE ? "AI Agent Security Singapore" : "AI Agent Security Singapore"}</h1>
          <p className="text-lg text-gray-300 mb-4">
            {isDE
              ? "Singapore Playbook für AI-Agent-Security: PDPA, Zero-Trust und reale Fixes für Moltbot."
              : "Singapore playbook for AI agent security: PDPA, zero-trust and real fixes for Moltbot."}
          </p>
        </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold mb-4 text-gray-100">{isDE ? "Singapore Fokus" : "Singapore focus"}</h2>
          <div className="space-y-4">
            {[
              [isDE ? "PDPA Compliance" : "PDPA compliance", isDE ? "Datenzugriff, Consent und Retention sauber dokumentieren." : "Document data access, consent and retention cleanly."],
              [isDE ? "FinTech Exposure" : "FinTech exposure", isDE ? "Integrationen mit Payment/Banking APIs hart absichern." : "Lock down integrations with payment/banking APIs."],
              ...
              [isDE ? "Audit Readiness" : "Audit readiness", isDE ? "Audit Trails lückenlos für Compliance-Checks." : "Keep audit trails complete for compliance checks."],
            ].map(([t, d]) => (
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              ...
              [3, isDE ? "mTLS aktivieren" : "Enable mTLS", isDE ? "Agent-zu-Agent Traffic kryptografisch sichern." : "Secure agent-to-agent traffic cryptographically."],
              [4, isDE ? "Audit Logs an SIEM" : "Audit logs to SIEM", isDE ? "PDPA-konforme Nachverfolgbarkeit sicherstellen." : "Ensure PDPA-compliant traceability."],
            ].map(([n, t, d]) => (
