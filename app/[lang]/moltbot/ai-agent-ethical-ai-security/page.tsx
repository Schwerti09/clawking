      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            {[
              ["1. Bias Detection & Mitigation", pick(isDE, "Systematische Erkennung und Reduktion von Bias in AI-Agent-Entscheidungen. Statistische Fairness-Metriken und Debiasing-Techniken.", "Systematic detection and reduction of bias in AI agent decisions. Statistical fairness metrics and debiasing techniques.")],
              ["2. Fairness Testing", pick(isDE, "Automatisiertes Fairness Testing für AI-Agents über demographische Gruppen. Disparate Impact Analysis und Equalized Odds.", "Automated fairness testing for AI agents across demographic groups. Disparate impact analysis and equalized odds.")],
              ["3. EU AI Act Compliance", pick(isDE, "Compliance mit dem EU AI Act. Risikoklassifizierung, Transparenzpflichten und Konformitätsbewertung für AI-Systeme.", "Compliance with the EU AI Act. Risk classification, transparency obligations and conformity assessment for AI systems.")],
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            {[
              [1, pick(isDE, "AI Act Risikoklasse bestimmen", "Determine AI Act risk class"), pick(isDE, "Klassifizieren Sie Ihren AI-Agent nach EU AI Act. High-Risk-Systeme erfordern Konformitätsbewertung.", "Classify your AI agent per EU AI Act. High-risk systems require conformity assessment.")],
              [2, pick(isDE, "Bias Baseline messen", "Measure bias baseline"), pick(isDE, "Messen Sie Bias-Metriken vor Deployment. Demographische Parität, Equalized Odds, Calibration.", "Measure bias metrics before deployment. Demographic parity, equalized odds, calibration.")],
              [3, pick(isDE, "Fairness Constraints implementieren", "Implement fairness constraints"), pick(isDE, "Integrieren Sie Fairness Constraints in Training und Inference. In-processing und Post-processing Methoden.", "Integrate fairness constraints in training and inference. In-processing and post-processing methods.")],
              [4, pick(isDE, "XAI-Methoden einbinden", "Integrate XAI methods"), pick(isDE, "SHAP oder LIME für Entscheidungserklärungen einbinden. Für jeden Agent-Output nachvollziehbar.", "Integrate SHAP or LIME for decision explanations. Traceable for every agent output.")],
              [5, pick(isDE, "Dokumentation & Reporting", "Documentation & reporting"), pick(isDE, "Erstellen Sie AI-System-Dokumentation nach EU AI Act Anforderungen. Technical Documentation und Instructions for Use.", "Create AI system documentation per EU AI Act requirements. Technical documentation and instructions for use.")],
            ].map(([n, title, desc]) => (
