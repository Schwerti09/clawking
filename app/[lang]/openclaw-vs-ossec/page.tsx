        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-blue-900 border border-blue-700 p-5 rounded-lg">
              <h3 className="font-bold text-blue-300 mb-3">🔒 {pick(isDE, 'OSSEC ist die Wahl wenn...', 'OSSEC is the choice when...')}</h3>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <a href={`/${lang}/openclaw/server-hardening-checklist`} className="block bg-gray-800 p-4 rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors">
              <div className="font-semibold text-cyan-400">🖥️ {pick(isDE, 'Server Hardening', 'Server Hardening')}</div>
              <div className="text-sm text-gray-300">{pick(isDE, 'Server Checklist Runbook', 'Server Checklist Runbook')}</div>
            </a>
            ...
            <a href={`/${lang}/openclaw-vs-wazuh`} className="block bg-gray-800 p-4 rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors">
              <div className="font-semibold text-cyan-400">🦅 {pick(isDE, 'OpenClaw vs Wazuh', 'OpenClaw vs Wazuh')}</div>
              <div className="text-sm text-gray-300">{pick(isDE, 'Ähnlicher Vergleich', 'Similar comparison')}</div>
            </a>
          </div>
        </section>
      </div>
