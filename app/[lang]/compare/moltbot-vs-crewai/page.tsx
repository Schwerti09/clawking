...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  const title = isDE
    ? "Moltbot vs CrewAI: Security-Vergleich 2026 | ClawGuru"
    : "Moltbot vs CrewAI: Security Comparison 2026 | ClawGuru"
  const description = isDE
    ? "Moltbot vs CrewAI im Security-Vergleich: Multi-Agent Orchestration Security, Self-Hosted vs Cloud, Audit Logging und Role-Based Agent Security direkt verglichen 2026."
    : "Moltbot vs CrewAI security comparison: multi-agent orchestration security, self-hosted vs cloud, audit logging and role-based agent security compared 2026."
  return {
    title, description,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-4 text-gray-100">{isDE ? "Moltbot vs CrewAI" : "Moltbot vs CrewAI"}</h1>
        <p className="text-lg text-gray-300 mb-6">
          {isDE
            ? "CrewAI macht Multi-Agent-Workflows intuitiv — aber Agent Isolation und Audit Logging fehlen out-of-the-box. Moltbot erzwingt Security von Anfang an."
            : "CrewAI makes multi-agent workflows intuitive — but agent isolation and audit logging are missing out of the box. Moltbot enforces security from the start."}
        </p>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <a href={`/${locale}/compare/openclaw-vs-aquasec`} className="block bg-gray-800 p-4 rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors">
              ...
              <div className="text-sm text-gray-300">{isDE ? "Aquasec-Vergleich" : "Aquasec comparison"}</div>
            </a>
