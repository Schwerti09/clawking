...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  const title = pick(isDE, "ClawGuru vs Wiz Code: Vergleich | ClawGuru Compare", "ClawGuru vs Wiz Code: Comparison | ClawGuru Compare")
  const description = pick(isDE, "ClawGuru vs Wiz Code: Self-Hosted vs Cloud. Deployment, Security, Compliance, Pricing und Control vergleichen. Executable Runbooks für Self-Hosted Security-Checks.", "ClawGuru vs Wiz Code: Self-Hosted vs Cloud. Compare deployment, security, compliance, pricing and control. Executable runbooks for self-hosted security checks.")
  return {
    title, description,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-4 text-gray-100">{pick(isDE, "ClawGuru vs Wiz Code", "ClawGuru vs Wiz Code")}</h1>
