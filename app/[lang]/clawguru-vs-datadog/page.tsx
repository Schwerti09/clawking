  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-4 text-gray-100">ClawGuru vs Datadog: Monitoring & Security Comparison</h1>
        <p className="text-lg text-gray-300 mb-8">Comprehensive monitoring platform comparison for security observability, infrastructure monitoring, and DevOps teams.</p>
            ...
            <table className="min-w-full bg-gray-900 border border-gray-700 rounded-lg">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-yellow-400">Basic security features</td>
                </tr>
                <tr className="bg-gray-800">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100">Infrastructure Monitoring</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-green-400">System metrics & logs</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-green-400">Comprehensive monitoring</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100">Application Performance</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-yellow-400">Limited APM</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-green-400">Advanced APM & RUM</td>
                </tr>
                <tr className="bg-gray-800">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-yellow-400">Per-host/usage subscription</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="font-bold text-cyan-400 mb-3">Datadog Architecture</h3>
                <ul className="space-y-2 text-sm text-gray-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-4 rounded border">
                ...
                <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <li className="text-green-400">No per-host fees after initial license</li>
                </ul>
              </div>
              <div className="bg-white p-4 rounded border">
                <h3 className="font-bold text-cyan-400 mb-3">Datadog Pricing</h3>
                <ul className="space-y-2 text-sm text-gray-300">
                  ...
                  <li className="text-red-400">Usage-based pricing can be expensive</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-purple-900 p-4 rounded-lg border border-purple-700">
              <h3 className="font-semibold text-purple-300 mb-2">Datadog Integrations</h3>
              <ul className="text-sm space-y-1">
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-900 p-4 rounded-lg border border-blue-700">
              <h3 className="font-semibold text-blue-300 mb-2">ClawGuru Security</h3>
              <ul className="text-sm space-y-1">
            ...
            <div className="bg-purple-900 p-4 rounded-lg border border-purple-700">
              <h3 className="font-semibold text-purple-300 mb-2">Datadog Security</h3>
              <ul className="text-sm space-y-1">
