...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildLocalizedAlternates(locale, "/datadog-security"),
    openGraph: {
      images: ["/og-image.png"],
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">Datadog Security Architecture</h2>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">API Keys & Application Keys</h2>
...
process_config:
  ...
  strip_proc_arguments: true`}
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">RBAC & Custom Roles</h2>
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <pre className="font-mono text-sm text-green-400">
...
# Set "Restrict access" and select team`}
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-100 mb-6">Sensitive Data Scanner</h2>
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <pre className="font-mono text-sm text-green-400">
